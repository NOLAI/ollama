...
This is a fork of Ollama which we at NOLAI use for our Framework desktops. The Ollama team have stated that RPC is not their main priority so, we want to keep our own fork maintaining it. 

We sometimes will also add different features that we like such as HF model downloads. If you have any questions feel free to contact us. 
